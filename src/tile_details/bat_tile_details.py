...
class BatTileDetails(TileDetails):
    def __init__(self, tile, layer):
        ...
        self._start_delay = TmxHelper.get_tiled_object_value('start_delay', 10, self.tile, self.layer)
        ...
        self._points_path = GameHelper.convert_string_to_list_of_tuples(
            TmxHelper.get_tiled_object_value('points_path', '', self.tile, self.layer))
