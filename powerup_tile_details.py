...
class PowerupTileDetails(TileDetails):
    def __init__(self, tile, layer):
        ...
        self._powerup_name = tmx_helper.get_property('powerup_name', '', self.tile, self.layer)
        self._powerup_volume = int(tmx_helper.get_property('powerup_volume', 0, self.tile, self.layer))
